...
1. `print_and_return_number`
    ...
    컴포넌트가 반환값이 있음을 알려주기 위해서 타입힌트를 추가하겠습니다.
    입력받은 값을 출력함으로 int를 return 힌트로 입력합니다.
...
<img src="/images/docs/kubeflow/pipeline-0.png" title="pipeline-order"/>
...
`kfp.dsl.pipeline`을 통해서 변환할 수 있습니다.
